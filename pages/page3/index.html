...
<body>
  <div class="layout">
    <aside class="sidebar">
      <a href="../page2/index.php" class="nav-btn">About Me</a>
      <a href="../page3/index.php" class="nav-btn">Hobbies and Skills</a>
      <a href="../page4/index.php" class="nav-btn">Organizations</a>
      <a href="../page5/index.php" class="nav-btn">Gallery</a>
      <div class="bot-btn">
        <a href="../../index.php" class="nav-btn">Exit</a>
        <a href="../page1/index.php" class="nav-btn">Nav</a>
      </div>
    </aside>
